...
{    
    ...
    this.VALUE = "val";
    this.FILE = "file";
	this.HIT_AREA_MOTION = "motion";
	this.MOTION_EXP = "expression";
	this.MOTION_TXT = "text";
    this.json = {};
}
...
{    
    ...
    pm.loadBytes(path, function(buf) {
		...
		thisRef.json = pm.jsonParseFromBytes(buf);
        callback();
    });
};

ModelSettingJson.prototype.getName = function() {
	return this.json[this.NAME];
}
...
ModelSettingJson.prototype.getHitAreaMotion = function(n)
{
    if (this.json[this.HIT_AREAS] == null || 
        this.json[this.HIT_AREAS][n] == null)
        return null;

    return this.json[this.HIT_AREAS][n][this.HIT_AREA_MOTION];
}
...
ModelSettingJson.prototype.getMotionExpression = function(name, n)
{
    if (this.json[this.MOTION_GROUPS] == null || 
        this.json[this.MOTION_GROUPS][name] == null || 
        this.json[this.MOTION_GROUPS][name][n] == null || 
        this.json[this.MOTION_GROUPS][name][n][this.MOTION_EXP] == null)
        return null;

    return this.json[this.MOTION_GROUPS][name][n][this.MOTION_EXP];
}
...
ModelSettingJson.prototype.getMotionText = function(name, n)
{
    if (this.json[this.MOTION_GROUPS] == null || 
        this.json[this.MOTION_GROUPS][name] == null || 
        this.json[this.MOTION_GROUPS][name][n] == null || 
        this.json[this.MOTION_GROUPS][name][n][this.MOTION_TXT] == null)
        return null;

    return this.json[this.MOTION_GROUPS][name][n][this.MOTION_TXT];
}
