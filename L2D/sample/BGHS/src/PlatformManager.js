...
PlatformManager.prototype.urlExists = function(url)
{
...
PlatformManager.prototype.loadLive2DModelByte = function(byteArray, callback)
{
    var model = null;
    
    // load moc
	model = Live2DModelWebGL.loadModel(byteArray);
	callback(model);
}
...
PlatformManager.prototype.textParseFromBytes = function(buf){
...
PlatformManager.prototype.jsonToArrayBuffer = function(json){
    
	// Assume UTF-8 without BOM
	let enc = new TextEncoder("utf-8");
	let jsonStr = JSON.stringify(json)	
	let buf = enc.encode(jsonStr);
	return buf;
    //var jsonStr;
    //
    //
