...
function AppComponent_app_tile_3_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "app-tile", 4);
...
class AppComponent {
    ...
    onResize(event) {
        ...
        //AppSettings.BaseSize = Math.floor(size / AppSettings.SideCnt);
        ////console.log(AppSettings.BaseSize);
    }
    get Side() {
        return (_AppSettings__WEBPACK_IMPORTED_MODULE_2__["AppSettings"].BaseSize * _AppSettings__WEBPACK_IMPORTED_MODULE_2__["AppSettings"].SideCnt) + 'px';
    }
    initTiles(result) {
        let tiles = [];
        for (var i = 0; i < result.length; i++)
            tiles.push(new _models_ITile__WEBPACK_IMPORTED_MODULE_1__["Tile"](i, result[i]).resetPost(_AppSettings__WEBPACK_IMPORTED_MODULE_2__["AppSettings"].SideCnt, _AppSettings__WEBPACK_IMPORTED_MODULE_2__["AppSettings"].BaseSize));
        return tiles;
    }
    initEmptyValues() {
    ...
    moveTile(tile, toId, dir) {
        let limit = 0;
        let stepSize = _AppSettings__WEBPACK_IMPORTED_MODULE_2__["AppSettings"].BaseSize / 10;
        if (dir == 1 /* Up */)
            limit = tile.top - _AppSettings__WEBPACK_IMPORTED_MODULE_2__["AppSettings"].BaseSize;
        if (dir == 2 /* Down */)
            limit = tile.top + _AppSettings__WEBPACK_IMPORTED_MODULE_2__["AppSettings"].BaseSize;
        if (dir == 3 /* Left */)
            limit = tile.left - _AppSettings__WEBPACK_IMPORTED_MODULE_2__["AppSettings"].BaseSize;
        if (dir == 4 /* Right */)
            limit = tile.left + _AppSettings__WEBPACK_IMPORTED_MODULE_2__["AppSettings"].BaseSize;
        this.timer = setInterval(() => {
            ...
            if (isFinish) {
                ...
                tile.id = toId;
                tile.resetPost(_AppSettings__WEBPACK_IMPORTED_MODULE_2__["AppSettings"].SideCnt, _AppSettings__WEBPACK_IMPORTED_MODULE_2__["AppSettings"].BaseSize);
                this.timer = -1;
                if (this.isCompleted())
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], hostBindings: function AppComponent_HostBindings(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 4, vars: 1, consts: [[1, "imageSelect"], [3, "childEvent"], [1, "tileBoard"], [3, "ImageUrl", "Tile", "childEvent", 4, "ngFor", "ngForOf"], [3, "ImageUrl", "Tile", "childEvent"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_pages_image_image_component__WEBPACK_IMPORTED_MODULE_3__["ImageComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgForOf"], _pages_tile_tile_component__WEBPACK_IMPORTED_MODULE_5__["TileComponent"]], styles: [".clipImageParent[_ngcontent-%COMP%] {\r\n    position: absolute;\r\n    \r\n    -webkit-clip-path: inset(0% 0% 0% 0%);\r\n            clip-path: inset(0% 0% 0% 0%);\r\n}\r\n\r\n.imageSelect[_ngcontent-%COMP%]{\r\n    \r\n    color: white;\r\n    padding:10px;\r\n    background-color : blue;\r\n    max-width:200px;\r\n\r\n    position:fixed;\r\n    top:0px;\r\n    right:0px;\r\n    z-index: 100;\r\n}\r\n\r\n\r\n\r\n.tileBoard[_ngcontent-%COMP%] {\r\n    \r\n    background-color: red;  \r\n    height: 600px;\r\n    width: 600px;\r\n    margin:10px auto;\r\n    \r\n    \r\n    border: 10px solid red;\r\n    position:relative;\r\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
TileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TileComponent, selectors: [["app-tile"]], inputs: { ImageUrl: "ImageUrl", Tile: "Tile" }, outputs: { childEvent: "childEvent" }, decls: 2, vars: 9, consts: [[1, "tile", 3, "ngStyle", "click"], [3, "ngStyle"]], template: function TileComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["NgStyle"]], styles: [".tile[_ngcontent-%COMP%] {\r\n    width:142px;\r\n    height:142px;\r\n    \r\n    overflow:hidden;\r\n    position: absolute;\r\n    background-color:grey;\r\n    margin: 4px;\r\n    cursor: pointer;\r\n    \r\n}\r\n\r\n.img[_ngcontent-%COMP%] {\r\n    position:relative;\r\n    \r\n    width: 600px;\r\n    height: 600px;\r\n}\r\n\r\n.img-0[_ngcontent-%COMP%] {\r\n    top: 200px;\r\n    left: 200px;\r\n}\r\n\r\n.img-1[_ngcontent-%COMP%], .img-2[_ngcontent-%COMP%], .img-3[_ngcontent-%COMP%], .img-4[_ngcontent-%COMP%] {\r\n    top : 0px;\r\n}\r\n\r\n.img-5[_ngcontent-%COMP%], .img-6[_ngcontent-%COMP%], .img-7[_ngcontent-%COMP%], .img-8[_ngcontent-%COMP%] {\r\n    top : -150px;\r\n}\r\n\r\n.img-9[_ngcontent-%COMP%], .img-10[_ngcontent-%COMP%], .img-11[_ngcontent-%COMP%], .img-12[_ngcontent-%COMP%] {\r\n    top : -300px;\r\n}\r\n\r\n.img-13[_ngcontent-%COMP%], .img-14[_ngcontent-%COMP%], .img-15[_ngcontent-%COMP%], .img-16[_ngcontent-%COMP%] {\r\n    top : -450px;\r\n}\r\n\r\n.img-1[_ngcontent-%COMP%], .img-5[_ngcontent-%COMP%], .img-9[_ngcontent-%COMP%], .img-13[_ngcontent-%COMP%] {\r\n    left : 0px;\r\n}\r\n\r\n.img-2[_ngcontent-%COMP%], .img-6[_ngcontent-%COMP%], .img-10[_ngcontent-%COMP%], .img-14[_ngcontent-%COMP%] {\r\n    left : -150px;\r\n}\r\n\r\n.img-3[_ngcontent-%COMP%], .img-7[_ngcontent-%COMP%], .img-11[_ngcontent-%COMP%], .img-15[_ngcontent-%COMP%] {\r\n    left : -300px;\r\n}\r\n\r\n.img-4[_ngcontent-%COMP%], .img-8[_ngcontent-%COMP%], .img-12[_ngcontent-%COMP%], .img-16[_ngcontent-%COMP%] {\r\n    left : -450px;\r\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
